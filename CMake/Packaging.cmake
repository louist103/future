...
execute_process(
  ...
  COMMAND
    ...
    --executable=$<TARGET_FILE:future>
    $<$<BOOL:$<TARGET_PROPERTY:future,APPIMAGE_DESKTOP_FILE>>:--desktop-file=$<TARGET_PROPERTY:future,APPIMAGE_DESKTOP_FILE>>
    $<$<BOOL:$<TARGET_PROPERTY:future,APPIMAGE_ICON_FILE>>:--icon-file=$<TARGET_PROPERTY:future,APPIMAGE_ICON_FILE>>
    --output=appimage
     --verbosity=2
)
]])
